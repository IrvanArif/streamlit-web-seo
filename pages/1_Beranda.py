...
# Konfigurasi halaman
st.set_page_config(
    page_title="Beranda - Peringkas Meta SEO",
    page_icon="🏠",
    layout="wide"
)
...
st.info("Silakan pilih halaman **'Metadeskripsi'** dari menu navigasi di sebelah kiri untuk mulai membuat meta deskripsi SEO Anda secara otomatis!")
